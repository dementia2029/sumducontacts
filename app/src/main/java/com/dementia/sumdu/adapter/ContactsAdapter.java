...
import com.dementia.sumdu.activity.MainActivity;
import com.dementia.sumdu.activity.SplashActivity;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context2, ViddilActivity.class);
                intent.putExtra("pidrozdil_id", contact.contactId);
