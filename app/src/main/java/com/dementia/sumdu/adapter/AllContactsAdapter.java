...
public class AllContactsAdapter extends SearchablePinnedHeaderListViewAdapter<Contact> {
    ...
    public AllContactsAdapter(ArrayList<Contact> contacts, Context context, int pidrozdil_id, int viddil_id) {
        this.viddil_id=viddil_id;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context2, ShowInfo.class);
                intent.putExtra("pidrozdil_id",pidrozdil_id);
                intent.putExtra("viddil_id",viddil_id);
